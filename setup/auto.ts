...
import { getInstallableProviderDescriptor, listInstallableProviderDescriptors } from './providers/skill-descriptor.js';
// Provider payloads self-register their picker entry + auth on import.
import './providers/index.js';
import './provider-contracts/index.js';
import { assertSetupProviderConformance, providerImagePolicy } from './provider-contracts/registry.js';
...
async function main(): Promise<void> {
  ...
  if (!skip.has('auth')) {
    ...
    if (!providerEntry) {
      ...
      await import(`./provider-contracts/${agentProvider}.js`);
